# Generated by Django 3.1.14 on 2025-02-16 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attack', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Атака')),
                ('protection', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Защита')),
                ('endurance', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Выносливость')),
